...
Survey design for <!-- the --> `r yr` and `r yr+1` sablefish research and assessment <!-- KH: surveys--> employed a stratified random sampling (StRS) component and a traditional standardized component (Table \@ref(tab:Table1)). In `r yr`,  two exploratory sets were added (Figure \@ref(fig:figure1)).  Under the StRS component, random fishing sets were conducted in five spatial and three depth strata (Figure \@ref(fig:figure2), and Figure \@ref(fig:figure3)).  The traditional component consisted of standardized fishing sets at nine offshore indexing localities (Figure \@ref(fig:figure2), and Figure \@ref(fig:figure3)) and four mainland inlets (Figure \@ref(fig:figure4)).

### STRATIFIED RANDOM SAMPLING SURVEY DESIGN COMPONENT

The StRS design began in 2003 with the purpose of distributing tag releases at random, collecting biological samples and developing a catch-rate based index of abundance [@Wyeth2003]. It also provided an alternative design to the historic traditional offshore component of the survey which occurred at fixed locations. 
...
The Federal Court of Appeal ruling (Larocque v. Canada (Minister of Fisheries and Oceans Canada) [@Larocque2006]) was used to support scientific research of key commercial fish in place of quota allocation. <!-- KH comment: The ruling itself didn't support research.  Do you mean to say that DFO covered the full financial cost of the survey in 2008 and 2009 as a result of the Larocque ruling? --> As a result, sablefish in traps assigned code D were released at sea.

<!--KH suggested revision to above paragraph:
In previous survey years, Sablefish assigned to code D were retained for sale to help fund survey costs. As a result of the Federal Court of Appeal ruling Larocque v. Canada (Minister of Fisheries and Oceans Canada) [@Larocque2006], this practice was not permitted in 2008 and 2009.  As a result, DFO provided emergency funds to support the survey in these years and all Sablefish in traps assigned code D were released at sea. 

(Although, maybe my summary should be fact checked? as I'm not 100% clear if this is correct? - although, maybe you know???)

In any case, it seems the key points to get across in the paragraph is that these years were different from previous years because no fish were retained for sale.
-->
